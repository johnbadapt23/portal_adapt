  ...
  <?php if($active_sub) { ?>
    <div id="mpca-add-sub-user" class="mpca-fat-bottom">
        ...
        if($manage_sub_accounts_form == 'add' && !empty($errors)){
          ...
          if(isset($_POST['userdata'])){
            if(is_array($_POST['userdata'])){
              ...
              $form_data['mepr_company_name'] = isset($_POST['userdata']['mepr_company_name']) ? $_POST['userdata']['mepr_company_name'] : '';
      ...
      <?php if(!$mepr_options->username_is_email): ?>
        ...
        <?php endif ?>
		<label>		
        <?php if($user_info->mepr_company_name) {?>
          <input id="" type="hidden" name="userdata[mepr_company_name]" value="<?php echo $user_info->mepr_company_name; ?>"/>
          <?php } else { ?> 
            <span><?php _e('Company Name', 'memberpress-corporate'); ?></span>
            <input id="" type="text" name="userdata[mepr_company_name]" value="<?php echo esc_attr($form_data['mepr_company_name']); ?>"/> 
          <?php } ?>
	    </label>
        <label>
