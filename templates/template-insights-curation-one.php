                ...
                <div class="sortContainer desktop">
                    ...
                    <div id="filterBy">
                        ...
                        <select class="dropdown-class" name="filter-posts" id="filterBox" onchange="document.location.href=location.href+this.options[this.selectedIndex].value;">
                            ...
                            <?php foreach($terms as $term) { ?>
                                <option <?php if ($filterType == $term -> slug){?> selected=""<?php } ?>value="<?php if ($filterTopics != '' || $sortBy != '' || $keyword != '' ) { ?>&<?php } else { ?>?<?php } ?>filterType=<?php echo $term -> slug; ?>"><?php echo $term -> name; ?></option>
                            <?php } ?>
                        </select>
                    </div>
