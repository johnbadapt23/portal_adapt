        ...
        <span class="article-column-container">
            <span class="article-text-column">
                <span class="text-inner">   
                    ...
                    <span class="article-title headerXsmall text-bold text-black"><?php echo $postTopic->name; ?> Buyer Persona Profile</span>
            ...
            <span class="article-image-column">
                <span class="image-container">
					...
					if ( $inline_img_153_attach_id ) {
						echo wp_get_attachment_image( $inline_img_153_attach_id, 'full', false, array( 'alt' => esc_attr(get_the_title($post_id)), 'class' => 'article-image' ) );
					} elseif ( $inline_img_153_src ) {
						echo '<img class="article-image" src="' . esc_url( $inline_img_153_src ) . '" loading="lazy" alt="' . esc_attr( esc_attr(get_the_title($post_id)) ) . '" />';
					}
				?>
                            <?php if($video == 'yes'){ ?>
