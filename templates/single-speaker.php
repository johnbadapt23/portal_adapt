                            ...
                            <span class="links-container">
                                ...
                                <?php if ( have_rows( 'buttons' ) ) : ?>
                                    <?php while ( have_rows( 'buttons' ) ) : the_row(); ?>
                                        ...
                                        // row's trigger/target pair unique - combined with
                                        // get_the_ID() since this whole block also sits inside an
                                        // outer "introduction" repeater, so it can repeat per-post.
