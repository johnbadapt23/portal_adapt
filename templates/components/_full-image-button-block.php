<section class="videoBlock image-button-block scrollPos" style="background-image: url(<?php echo esc_url( get_sub_field('image') ); ?>);" <?php if( get_sub_field('id')){?>id="<?php echo esc_attr( get_sub_field('id') ); ?>"<?php } ?>>
        ...
        <div class="content">
            ...
            <?php if( get_sub_field ( 'description' ) ) { ?>
                <div class="column text">
                    <span class="text"><?php echo esc_html( get_sub_field('description') ); ?></span>
                </div>
            <?php } ?>
