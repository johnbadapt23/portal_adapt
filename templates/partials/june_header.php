...
<header class="header clear<?php if(get_field( 'remove_main_menu' )){ ?> <?php the_field( 'remove_main_menu' ); ?><?php } ?>" role="banner">
	<div class="top">
		<div class="container">
			<span class="logo">
                                    	...
                                    	<?php while ( have_rows( 'menu_links_top', 'option' ) ) : the_row(); ?>
                                    		<?php if ( have_rows( 'link' ) ) : ?>
                                    			<?php while ( have_rows( 'link' ) ) : the_row(); ?>
                                    				<a class="userMenuLink" href="<?php the_sub_field( 'link' ); ?>" target="<?php the_sub_field( 'link_target' ); ?>"><?php the_sub_field( 'link_text' ); ?></a>
                                    			<?php endwhile; ?>
                                    		<?php else : ?>
                                    			<?php // no rows found ?>
                                    		<?php endif; ?>
                            ...
                            <?php if ( have_rows( 'menu_links_bottom', 'option' ) ) : ?>
                                <div class="userMenuBottom">
                                	<?php while ( have_rows( 'menu_links_bottom', 'option' ) ) : the_row(); ?>
                                		<?php if ( have_rows( 'link' ) ) : ?>
                                			<?php while ( have_rows( 'link' ) ) : the_row(); ?>
                                                <a class="userMenuLink <?php the_sub_field( 'link_class' ); ?>" href="<?php the_sub_field( 'link' ); ?>" target="<?php the_sub_field( 'link_target' ); ?>"><?php the_sub_field( 'link_text' ); ?></a>
                                			<?php endwhile; ?>
                                		<?php else : ?>
                                			<?php // no rows found ?>
                                		<?php endif; ?>
		...
		<div class="container">
			<span class="desktopNav">
				<ul>
                                                            ...
                                                            <ul>
                                            					<?php while ( have_rows( 'link' ) ) : the_row(); ?>
                                                                    ...
                                                                    <?php } else { ?>
                                                                        ...
                                                                        <?php if ( $other_link ): ?>
                                                                            <li>
                                                                                <a href="<?php the_sub_field( 'other_link' ); ?>" ><?php echo $other_link; ?></a>
                                                                            </li>
                                                						<?php endif; ?>
                                                                    <?php } ?>
                                            					<?php endwhile; ?>
                    ...
                    <?php if ($membershipType == 'advantage') { ?>
                        <li>
                            <a href="/persona-mapping/">Persona Mapping</a>
                        </li>
                    <?php } ?>
                    ...
                    <?php if ($membershipType == 'it-pro') { ?>
    					<li>
    						<a href="/get-advice/">Get Advice</a>
    					</li>
                    <?php } ?>
				</ul>
			</span>
