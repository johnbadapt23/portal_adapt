<?php
/**
 * Template Name: Persona Data & Insights Listing Template
 */
	    ...
	    <section class="eventsBanner topicBanner sectorBanner" style="background-image:url(<?php echo esc_url( $banner_image['url'] ); ?>); background-size: cover; background-position: center;">
	        <div class="container">
	            <span class="back-to-sectors topicFilter">
	                <a href="/data-insights/persona-mapping/" target="_self">Persona Mapping</a>
	            </span>
							...
							?>
	                            ...
	                            <div class="textContainer">
	                                <span class="topicFilter">
	                                    ...
	                                    <a href="/data-insights/persona-mapping/?persona=<?php echo esc_attr( $persona ); ?>" class="topicFilterText"><?php echo esc_html( $taxonomy_details->name ); ?></a>
	                                    <?php if($postType){?>
...
<?php } else { ?>
					...
					<div class="button-container">
						...
						<?php if ( $sectors_terms ): ?>
							<?php foreach ( $sectors_terms as $sectors_term ): ?>
								<a class="sector-button button grey-button" href="/data-insights/persona-mapping/?persona=<?php echo esc_attr( $sectors_term->slug ); ?>" target="_self"><strong><?php echo esc_html( $sectors_term->name ); ?></strong><?php if(get_field( 'persona_title', $sectors_term )){ ?> (<?php echo esc_html( get_field( 'persona_title', $sectors_term ) ); ?>)<?php } ?></a>
							<?php endforeach; ?>
						<?php endif; ?>
					</div>
				<?php endwhile; ?>
													...
													<span class="v-wrap">
														<span class="v-box">
							                                <span class="topicFilter">
							                                    ...
							                                    <?php if($postType){?>
							                                        <a href="/data-insights/persona-mapping/?persona=<?php echo esc_attr( $postType->slug ); ?>" class="topicFilterText"><?php echo esc_html( $postType->name ); ?></a>
							                                    <?php } ?>
							                                </span>
	...
	<?php if ( have_rows( 'persona' ) ) : ?>
		<?php while ( have_rows( 'persona' ) ) : the_row(); ?>
			<?php get_template_part( 'templates/components/_persona-grid-portal' ); ?>
		<?php endwhile; ?>
	<?php else : ?>
		<section class="portal postListing topicGrid sector-grid persona-grid subTopic sector-container">
		 <div class="container">
							...
							?>
							 ...
							 <div class="textContainer">
								 <span class="topicFilter">
									 ...
									 <a href="/data-insights/persona-mapping/?persona=<?php echo esc_attr( $persona->slug ); ?>" class="topicFilterText"><?php echo esc_html( $persona->name ); ?></a>
									 <?php if($postType){?>
										 <a href="/filter-types/<?php echo esc_attr( $postType->slug ); ?>" class="topicFilterText"><?php echo esc_html( $postType->name ); ?></a>
									 <?php } ?>
								 </span>
