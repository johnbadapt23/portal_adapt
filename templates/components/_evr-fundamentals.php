                        ...
                        <?php if ( have_rows( 'fundamentals' ) ) : ?>
                            <?php while ( have_rows( 'fundamentals' ) ) : the_row(); ?>
                                ...
                                <?php if ( $fundamental_term ): ?>
                                    <span class="other-fundamentals-items other-items"><a href="<?php echo get_term_link($fundamental_term); ?>" target="_self">
                        ...
                        <?php if ( have_rows( 'fundamentals' ) ) : ?>
                            <?php while ( have_rows( 'fundamentals' ) ) : the_row(); ?>
                                ...
                                <?php if ( $fundamental_term ): ?>
                                    <span class="other-fundamentals-items other-items"><a href="<?php echo get_term_link($fundamental_term); ?>" target="_self">
                                        <?php $icon = get_field( 'icon', $fundamental_term ); ?>
                                        <img src="<?php echo $icon['url']; ?>" alt="<?php echo $icon['alt']; ?>" width="24"/>Value from <?php echo $fundamental_term->name; ?> 
                                    </a></span>
                                <?php endif; ?>
                            <?php endwhile; ?>
                        <?php else : ?>
