	    ...
	    <div class="inner">
	        <div class="titleBlock">
				...
				<?php else : ?>
					<?php // no rows found ?>
				<?php endif; ?>
				<span class="already">Already a member? <a class="login" href="/login/?mepr-unauth-page=<?php echo esc_attr( $postID );?>&redirect_to=<?php echo esc_attr( $postURL );?>" target="_self">Login</a>
	        </div>
	    </div>
	</div>
</section>
