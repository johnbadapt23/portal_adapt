...
<?php if(current_user_can('mepr-active')){ ?>
    ...
    window.OneSignal = window.OneSignal || [];
     OneSignal.push(function() {
       OneSignal.init({
         appId: "942b6753-2774-4d47-acaf-89e3d6ca90da",
         safari_web_id: "web.onesignal.auto.65a2ca34-f112-4f9d-a5c6-253c0b61cb9f",
       });
     });

    OneSignal.push(function() {
      OneSignal.sendTag("user_name", "<?php echo $user_name; ?>");
      OneSignal.setExternalUserId(<?php echo $user_ID; ?>);
      OneSignal.sendTags({
        name: '<?php echo $user_name; ?>',
        email: '<?php echo $user_info->user_email; ?>',
        user_id: '<?php echo $user_ID; ?>',
        subscription: '<?php echo $memberships; ?>',
        topics: '<?php echo implode(", ", $interests_names); ?>',
        last_session: '<?php echo $user_info->last_action_time; ?>',
        account_type: '<?php echo $role; ?>',
        registration_date: '<?php echo $registration_date; ?>',
