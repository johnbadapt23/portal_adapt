<?php
/**
 * Template Name: Sectors Data & Insights Listing Template
 */
							...
							?>
	                            ...
	                            <div class="textContainer">
	                                <span class="topicFilter">
	                                    ...
	                                    <a href="/data-insights/sector-analysis/?sector=<?php echo $sector; ?>" class="topicFilterText"><?php echo $taxonomy_details->name; ?></a>
	                                    <?php if($postType){?>
					...
					<div class="button-container">
						...
						<?php if ( $sectors_terms ): ?>
							<?php foreach ( $sectors_terms as $sectors_term ): ?>
								<a class="sector-button button grey-button" href="/data-insights/sector-analysis/?sector=<?php echo $sectors_term->slug; ?>" target="_self"><strong><?php echo $sectors_term->name; ?></strong><?php if(get_field( 'sector_title', $sectors_term )){ ?> (<?php echo get_field( 'sector_title', $sectors_term ); ?>)<?php } ?></a>
							<?php endforeach; ?>
						<?php endif; ?>
					</div>
				<?php endwhile; ?>
													...
													<span class="v-wrap">
														<span class="v-box">
							                                <span class="topicFilter">
							                                    ...
							                                    <?php if($postType){?>
							                                        <a href="/data-insights/sector-analysis/?persona=<?php echo $postType->slug; ?>" class="topicFilterText"><?php echo $postType->name; ?></a>
							                                    <?php } ?>
							                                </span>
							...
							?>
							 ...
							 <div class="textContainer">
								 <span class="topicFilter">
									 ...
									 <a href="/data-insights/sector-analysis/?sector=<?php echo $sector->slug; ?>" class="topicFilterText"><?php echo $sector->name; ?></a>
									 <?php if($postType){?>
										 <a href="/filter-types/<?php echo $postType->slug; ?>" class="topicFilterText"><?php echo $postType->name; ?></a>
									 <?php } ?>
								 </span>
