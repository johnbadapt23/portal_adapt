<section class="speaker-text-carousel">
    <div class="container">
                        ...
                        <?php if ( have_rows( 'slides' ) ) : ?>
                            ...
                            <?php while ( have_rows( 'slides' ) ) : the_row(); ?>                        
                                <div class="speaker-slide-text<?php if ($speakerCounter == 1){ ?> active<?php } ?>">
                                    ...
                                    <h3 class="white-text bold-red"><?php echo get_sub_field( 'title' ); ?></h3>
                                    <p class="p-medium white-text"><?php echo get_sub_field( 'text' ); ?></p>
                                </div>
                                <?php $speakerCounter++; ?>
                            <?php endwhile; ?>
                        <?php else : ?>
