...
<div class="other-dropdown stages-dropdown">
    <div class="container">
        <?php
...
<section class="topicBanner">
    <div class="imageSizeContainer">
        ...
        <div class="container">
            ...
            <span class="title-filter-container"><h1><?php echo $q->name; ?></h1><span class="dropdown-button">Other stages</span></span>
                    ...
                    <span class="filterBy">
                        ...
                        <select name="filterby" id="" onchange="this.form.submit()">
                            ...
                            <?php if ( $loop->have_posts() ) : ?>
                                ...
                                <?php
                                    $types = get_the_terms( $post->ID, 'fundamentals-levers' );
                                    if($types){
