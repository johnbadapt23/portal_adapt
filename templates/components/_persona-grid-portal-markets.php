...
<section class="topicGrid portal sector-grid">
    <div class="container">
        <div class="blockTitle">
            ...
            <a href="/market-narratives/persona-mapping/?persona=<?php echo $sector_term->slug; ?>" class="viewAll">View All</a>
        </div>
                        ...
                        <div href="<?php the_permalink(); ?>" class="item">
                            ...
                            <div class="textContainer">
                                <span class="topicFilter">
                                    ...
                                    <a href="/market-narratives/persona-mapping/?persona=<?php echo $sector_term->slug; ?>" class="topicFilterText"><?php echo $sector_term->name; ?></a>
                                </span>
