<section class="two-column-text-image-cards <?php echo get_sub_field( 'background_colour' ); ?>">
    <div class="container">
        <div class="title-container" data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-duration="800">
            ...
            <div class="column-container card-container">
                <?php if ( have_rows( 'cards' ) ) : ?>
                    <?php while ( have_rows( 'cards' ) ) : the_row(); ?>
                        <div class="column one-half image-text-card background-light-grey" data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-duration="800">
