  ...
  <?php else: ?>
    ...
    <form name="mepr_loginform" id="mepr_loginform" class="mepr-form" action="<?php echo $login_url; ?>" method="post">
      ...
      <div class="mp-form-row mepr_username">
        <input type="text" name="log" id="user_login" value="<?php echo (isset($_REQUEST['log'])?esc_html($_REQUEST['log']):''); ?>" placeholder="Email address"/>
...
<script type="text/javascript">
    jQuery('img.show-password').on('click', function(e){
