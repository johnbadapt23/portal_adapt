...
jQuery(document).ready(function(){const t=document.querySelectorAll(".kits-listing.grid"),e=[];t.forEach(function(t){const c=new Isotope(t,{itemSelector:".kit-item",layoutMode:"fitRows"});e.push(c)}),document.querySelectorAll(".filter-group-listing").forEach(function(t){t.addEventListener("click",function(t){let c;const i=t.target.closest("a");if(i){c=i.getAttribute("data-filter"),i.classList.toggle("is-checked"),i.classList.contains("all-filter")?document.querySelectorAll(".kit-filter").forEach(function(t){t!==i&&t.classList.remove("is-checked")}):document.querySelector(".kit-filter.all-filter").classList.remove("is-checked");const t=[];document.querySelectorAll(".kit-filter.is-checked").forEach(function(e){t.push(e.getAttribute("data-filter"))}),0===t.length&&document.querySelector(".kit-filter.all-filter").classList.add("is-checked"),c=t.join(", "),e.forEach(function(t){t.arrange({filter:c})})}})})});