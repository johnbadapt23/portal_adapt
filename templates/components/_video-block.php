<section class="videoBlock scrollPos" style="background-image: url(<?php echo esc_url( get_sub_field('video_poster_image') ); ?>);" <?php if( get_sub_field('id')){?>id="<?php echo esc_attr( get_sub_field('id') ); ?>"<?php } ?>>
