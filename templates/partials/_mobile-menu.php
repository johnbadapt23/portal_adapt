                                                                ...
                                                                <span class="image-container">
                                                                    ...
                                                                    <?php if ($image) : ?>
                                                                        <span class="bg-container">
                                                                            <?php
					$inline_img_167_src = $image;
					$inline_img_167_attach_id = $inline_img_167_src ? attachment_url_to_postid( $inline_img_167_src ) : 0;
					if ( $inline_img_167_attach_id ) {
						echo wp_get_attachment_image( $inline_img_167_attach_id, 'full', false, array( 'alt' => esc_attr(get_the_title($post_id)), 'class' => 'article-image' ) );
					} elseif ( $inline_img_167_src ) {
						echo '<img class="article-image" src="' . esc_url( $inline_img_167_src ) . '" loading="lazy" alt="' . esc_attr( esc_attr(get_the_title($post_id)) ) . '" />';
					}
				?>
                                                                            <?php if($video == 'yes'){ ?>
